...
parser.add_argument("--model", default="gym_cartpole_model_2.h5", type=str, help="Output model path.")
## MY
...
def main(args: argparse.Namespace) -> Optional[tf.keras.Model]:
    ...
    if not args.evaluate:
        ...
        model = tf.keras.Sequential([
            tf.keras.layers.Input(shape=observations[0].shape),
