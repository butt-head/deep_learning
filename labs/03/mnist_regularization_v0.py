...
def main(args: argparse.Namespace) -> float:
    ...
    model.add(tf.keras.layers.Dropout(args.dropout, seed = args.seed))       ## USING SEED !!!
    ...
    # labels_categorical = 
    # print(mnist.train.data["labels"])
    # print(tf.keras.utils.to_categorical(mnist.train.data["labels"]))

    
    # print(MNIST.LABELS)
    # print(tf.keras.utils.to_categorical(MNIST.LABELS))
    ...
    ## Categorical CE
    cce = tf.keras.losses.CategoricalCrossentropy(label_smoothing=args.label_smoothing)
    model.compile(
