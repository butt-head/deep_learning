...
def main(args: argparse.Namespace) -> Dict[str, float]:
    ...
    train_generator = tf.keras.preprocessing.image.ImageDataGenerator(
                            ...
                            zca_whitening=False, zca_epsilon=1e-06, brightness_range=None, shear_range=0.0,
                            channel_shift_range=0.0, fill_mode='nearest', cval=0.0, vertical_flip=False, rescale=None,
