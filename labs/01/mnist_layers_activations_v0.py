...
def main(args: argparse.Namespace) -> float:
    ...
    # -DONE a `tf.keras.layers.Flatten()` layer
    # -DONE add `args.hidden_layers` number of fully connected hidden layers
    #  DONE `tf.keras.layers.Dense()` with  `args.hidden_layer` neurons, using activation
    #  DONE from `args.activation`, allowing "none", "relu", "tanh", "sigmoid".
